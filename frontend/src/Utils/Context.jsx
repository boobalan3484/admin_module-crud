...
export const AppProvider = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{
      ...
      loginLogs, logData, loggerInfo, handleLogValueChange, handleLoginSubmit, handleLogOut,
      employeeData, setEmployeeData, fetchDataTrigger, setFetchDataTrigger, search, setSearch, searchResult, setSearchResult,
      formData, handleNewValueChange, imagePreview, handleImageChange, handleFormSubmit, handleDeleteEmployee,
    }}>
      {children}
    </AppContext.Provider>
  );
